      ...
      <br>
        ...
        @csrf
            ...
            {{-- <div class="form-group col-sm-6">
              ...
              <input name="type" type="text" class="form-control" id="formGroupExampleInput2" value="{{$main->type}}" placeholder="type">
              @error('type')
              <small class="form-text text-danger">{{$message}}</small>
              @enderror
            </div> --}}
            <div class="form-group col-sm-6">
                ...
                <input name="link" type="text" class="form-control" id="formGroupExampleInput2" value="{{$main->link}}" placeholder="link">
                @error('link')
                <small class="form-text text-danger">{{$message}}</small>
                @enderror
              </div>
